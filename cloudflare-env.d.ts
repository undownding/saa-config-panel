/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a51d3b46f5e9d79ce5dfd1b0be42f6a9)
// Runtime types generated with workerd@1.20250803.0 2025-03-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		STORAGE_PROVIDER: "r2";
		R2_BUCKET_NAME: "saa-config";
		secrets_store_secrets: [{"binding":"AUTH_BEARER_TOKE","store_id":"d3e3ceb8d53046ccbafa2d817fc20039","secret_name":"AUTH_BEARER_TOKEN"}];
